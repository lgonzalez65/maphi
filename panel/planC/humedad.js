                ...
                if (document.getElementById("Update 2").checked) {
                  for (var channelIndex = 0; channelIndex < channelKeys2.length; channelIndex++)  // iterate through each channel
                  {
                    (function (channelIndex) {
                      ...
                      $.getJSON('https://www.thingspeak.com/channels/' + channelKeys2[channelIndex].channelNumber + '/feed/last.json?callback=?&amp;offset=0&amp;location=false;key=' + channelKeys2[channelIndex].key, function (data) {
