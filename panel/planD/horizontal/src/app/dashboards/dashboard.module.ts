...
import { DashboardMaphiComponent } from './dashboard-maphi/dashboard-maphi.component';
...
import { TemperaturaComponent } from './dashboard-components/temperatura/temperatura.component';
...
@NgModule({
  ...
  declarations: [
    ...
    WeathercardComponent,
    WeekpollComponent,
    DashboardMaphiComponent,
    LineaComponent,
    TemperaturaComponent
  ],
  providers:[
   DashboardMaphiService
  ]
})
